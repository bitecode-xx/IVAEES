...
public class Hello implements GLEventListener, KeyListener, MouseListener, MouseMotionListener {
	...
	public void mousePressed(MouseEvent arg0) {
		...
		System.out.println("mousex " + this.mousex);
		System.out.println("mousey " + this.mousey);
	...
	public void blah() {
		try {
			...
			MouseEvent blah = new MouseEvent(canvas, MouseEvent.MOUSE_PRESSED, msec, button, (int)test.position[0], (int)test.position[1], 1, false);
